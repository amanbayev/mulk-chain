...
>(({ className, children, side = "bottom", ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 gap-4 border border-border bg-card p-5 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out",
        side === "bottom" && "inset-x-0 bottom-0 rounded-t-md data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
